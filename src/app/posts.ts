export const DUMMY_DATA = {
  ...
  categories: [
    { name: 'إضاءة', count: 3, color: 'emerald', iconName: 'settings' },
    { name: 'بورتريه', count: 3, color: 'purple', iconName: 'person' },
    {
      name: 'مناظر طبيعية',
      count: 2,
      color: 'blue',
    ...
    { name: 'تقنيات', count: 5, color: 'orange', iconName: 'tune' },
    { name: 'معدات', count: 3, color: 'emerald', iconName: 'settings' },
  ],
  siteInfo: {
    name: 'عدسة',
